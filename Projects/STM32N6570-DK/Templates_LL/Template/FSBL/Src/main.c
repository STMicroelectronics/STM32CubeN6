...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
  /* initialize LED1 GPIO for DK board */
  LL_GPIO_InitTypeDef gpioO_init_struct = {
    .Pin = LL_GPIO_PIN_1,
  ...
  /* initialize LED2 GPIO for DK board */
  LL_GPIO_InitTypeDef gpioG_init_struct = {
    .Pin = LL_GPIO_PIN_10,
    .Mode = LL_GPIO_MODE_OUTPUT,
    .Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH,
    .OutputType = LL_GPIO_OUTPUT_PUSHPULL,
  ...
  /* Eenable GPIO clocks for STM32N657_DK */
  LL_AHB4_GRP1_EnableClock(LL_AHB4_GRP1_PERIPH_GPIOG);
  LL_AHB4_GRP1_EnableClock(LL_AHB4_GRP1_PERIPH_GPIOO);
  
  LL_GPIO_Init(GPIOO, &gpioO_init_struct);
  LL_GPIO_SetOutputPin(GPIOO, LL_GPIO_PIN_1);
  
  LL_GPIO_Init(GPIOG, &gpioG_init_struct);
  ...
  {
    /* Toggle leds */
    LL_GPIO_TogglePin(GPIOO, LL_GPIO_PIN_1);
    LL_mDelay(200);
