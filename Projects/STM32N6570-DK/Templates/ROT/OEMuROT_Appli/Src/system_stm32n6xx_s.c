/**
  ...
  *          to be used after the boot ROM execution in a secure application.
  *
...
#define VECT_TAB_BASE_ADDRESS 0x90000400 /* This define is updated automatically from OEMuROT_Boot project */
