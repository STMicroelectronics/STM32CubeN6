...
enum image_attributes
{
  ...
  RE_LOAD_AND_RUN = OEMUROT_LOAD_AND_RUN,
  RE_APPLI_S_ADDRESS = S_CODE_START + BL2_HEADER_SIZE,
  RE_APPLI_NS_ADDRESS = NS_CODE_START + BL2_HEADER_SIZE,

  RE_S_CODE_START = S_CODE_START,
  RE_S_CODE_LIMIT = S_CODE_LIMIT,
  RE_S_CODE_SIZE = S_CODE_SIZE,

  RE_NS_CODE_START = NS_CODE_START,
  RE_NS_CODE_LIMIT = NS_CODE_LIMIT,
  RE_NS_CODE_SIZE = NS_CODE_SIZE,

  RE_DATA_S_ADDRESS = S_DATA_START,
  RE_DATA_NS_ADDRESS = NS_DATA_START,
  RE_DATA_S_SIZE = S_DATA_SIZE,
  RE_DATA_NS_SIZE = NS_DATA_SIZE,
  RE_NS_DATA_START = NS_DATA_START,
  RE_NS_DATA_SIZE = NS_DATA_SIZE,
  RE_NS_DATA_LIMIT = NS_DATA_LIMIT,
  RE_NS_DATA2_START = NS_DATA2_START,
  RE_NS_DATA2_SIZE = NS_DATA2_SIZE,
  RE_NS_DATA2_LIMIT = NS_DATA2_LIMIT,
  ...
  RE_APP_IMAGE_NUMBER = MCUBOOT_APP_IMAGE_NUMBER,
  ...
  RE_OEMUROT_APPLI_FULL_SECURE = (0x1),
#else
  RE_OEMUROT_APPLI_FULL_SECURE = (0x0),
#endif
};
