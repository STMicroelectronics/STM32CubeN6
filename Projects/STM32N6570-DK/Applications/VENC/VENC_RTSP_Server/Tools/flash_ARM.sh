...
export APth="/c/git/n6/STM32Cube_FW_N6_V1.3.0_Ext_Refact/Projects/STM32N6570-DK/Applications/VENC/VENC_RTSP_Server_v1.4.0/MDK-ARM"
...
APP_NAME="VENC_RTSP"
BIN_PATH="$APth/Debug/VENC_RTSP_Debug/Project.bin"
FSBL_PATH="$APth/FSBL/VENC_RTSP_FSBL/Project.bin"
