...
/* USER CODE END RIF_Init 0 */
  ...
  LL_DMA_DisableChannelSecure(GPDMA1, LL_DMA_CHANNEL_2);
  ...
  LL_DMA_DisableChannelSecure(GPDMA1, LL_DMA_CHANNEL_3);
  ...
  HAL_GPIO_ConfigPinAttributes(GPIOA,GPIO_PIN_1,GPIO_PIN_SEC|GPIO_PIN_PRIV);
...
void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.BaseAddress = 0x341FB400;
