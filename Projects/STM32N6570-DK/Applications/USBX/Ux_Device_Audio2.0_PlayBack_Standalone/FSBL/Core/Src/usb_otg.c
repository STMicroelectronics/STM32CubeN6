...
/* Set hpcd_USB1_OTG_HS at the end of non-cacheable memory address ".UsbHpcdSection". */
...
void MX_USB1_OTG_HS_PCD_Init(void)
{
  ...
  hpcd_USB_OTG_HS1.Init.Sof_enable = ENABLE;
  ...
  /* Set Tx FIFO 1 */
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS1, 1, USBD_AUDIO_PLAY_EP_FEEDBACK_HS_MPS/4);
  #endif
