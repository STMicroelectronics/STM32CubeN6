...
/* Timing register value is computed with the STM32CubeMX Tool,
  * Fast Mode with I2CCLK = 600 MHz,
  * rise time = 100ns, fall time = 10ns
  * Timing Value = (uint32_t)0x00F07BFF
  */
#define I2C_TIMING               0x00F07BFF
...
static void MX_I2C1_Init(void)
{
  ...
  */
  ...
  I2C_InitStruct.Timing = 0x20D02371;
