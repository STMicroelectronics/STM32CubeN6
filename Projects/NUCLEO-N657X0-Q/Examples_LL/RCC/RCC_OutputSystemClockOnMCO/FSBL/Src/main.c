...
/**
  ...
  *          the system clock through the STM32N6xx RCC LL API.
  ******************************************************************************
  * @attention
  *
...
{
  {LL_RCC_MCO2SOURCE_HSE, LL_RCC_MCO2_DIV_1},
  {LL_RCC_MCO2SOURCE_HSI, LL_RCC_MCO2_DIV_1},
  {LL_RCC_MCO2SOURCE_SYSB, LL_RCC_MCO2_DIV_4}
};
