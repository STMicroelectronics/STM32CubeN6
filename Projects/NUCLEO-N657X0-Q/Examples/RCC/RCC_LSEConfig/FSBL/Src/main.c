...
int main(void)
{
  ...
  /* Output LSE on MCO2 pin(PC.09) */
  HAL_RCC_MCOConfig(RCC_MCO2, RCC_MCO2SOURCE_LSE, RCC_MCODIV_1);
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  HAL_RCC_MCOConfig(RCC_MCO2, RCC_MCO2SOURCE_HSI, RCC_MCODIV_1);
}
