...
int main(void)
{
  ...
  if(HAL_UART_Transmit_DMA(&hlpuart1, (uint8_t*)aTxStartMessage, TXSTARTMESSAGESIZE)!= HAL_OK)
  {
  ...
  if(HAL_UART_Transmit_DMA(&hlpuart1, (uint8_t*)aTxEndMessage, TXENDMESSAGESIZE)!= HAL_OK)
  {
    /* Transfer error in transmission process */
    Error_Handler();
  }
  ...
  static void SystemIsolation_Config(void)
{
  ...
  /* set GPDMA1 channel 0 used by LPUART1 */
  ...
  /* set GPDMA1 channel 1 used by LPUART1 */
