...
int main(void)
{
  ...
  if (HAL_SPI_TransmitReceive_IT(&hspi5, (uint8_t *)aTxBuffer, (uint8_t *)aRxBuffer, BUFFERSIZE) != HAL_OK)
  {
...
static void MX_SPI5_Init(void)
{
  ...
  hspi5.Init.CRCPolynomial = 0x107;
  hspi5.Init.CRCLength = SPI_CRC_LENGTH_16BIT;
