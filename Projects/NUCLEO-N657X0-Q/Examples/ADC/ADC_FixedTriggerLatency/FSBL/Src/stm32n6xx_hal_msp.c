...
/**
  ******************************************************************************
  * @file    Examples/ADC/ADC_FixedTriggerLatency/Src/stm32n6xx_hal_msp.c
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    if (HAL_DMAEx_List_InsertNode_Tail(&pQueueLinkList_GPDMACH0, &pNode_GPDMACH0) != HAL_OK)
    {
      Error_Handler();
    }
    ...
    if (HAL_DMA_ConfigChannelAttributes(&handle_GPDMA1_Channel0, DMA_CHANNEL_PRIV | DMA_CHANNEL_SEC | DMA_CHANNEL_SRC_SEC | DMA_CHANNEL_DEST_SEC) != HAL_OK)
    {
      Error_Handler();
    }
