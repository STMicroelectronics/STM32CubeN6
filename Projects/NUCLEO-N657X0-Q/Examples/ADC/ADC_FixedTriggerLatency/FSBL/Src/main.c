...
uint32_t uhADCxConvertedData_Voltage_mVolt[ADC_CONVERTED_DATA_BUFFER_SIZE] __NON_CACHEABLE;  /* Value of voltage calculated from ADC conversion data (unit: mV) (array of data) */
