...
/**
  ******************************************************************************
  * @file    PSSI/PSSI_Master_Single_Com/FSBL/Src/main.c
  * @author  MCD Application Team
  * @brief   This sample code shows how to use STM32N6xx PSSI HAL API to
             manage a Transmission procedure in polling mode.
  ******************************************************************************
  * @attention
  *
...
#define PULSE_VALUE         (uint32_t)(40 / 2)              /* Capture Compare 1 Value  */
/* Compute the prescaler value to have TIM1 counter clock equal to 1MHz */
#define PRESCALER_VALUE     (uint32_t)(((SystemCoreClock) / 80000000) - 1)
...
uint8_t aTxBuffer[] = "Hello from Master";
...
static void Start_Clock_Generation(void);
static void Stop_Clock_Generation(void);
...
int main(void)
{
  ...
  /* Send a buffer to Slave until end of transmission */
  while (HAL_PSSI_Transmit(&hpssi, aTxBuffer, TXBUFFERSIZE, 10000) != HAL_OK)
  {
  }

  /* Add a delay to let the receiver retrieve the last data */
  HAL_Delay(1);
...
/**
  * @brief This function starts the generation of the PWM signal generation.
  * @param None
  * @retval None
  */
static void Start_Clock_Generation(void)
...
/**
  * @brief This function stops the generation of the PWM signal generation.
  * @param None
  * @retval None
  */
static void Stop_Clock_Generation(void)
