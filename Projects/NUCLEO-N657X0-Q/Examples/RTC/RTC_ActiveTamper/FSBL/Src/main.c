...
/**
  ...
  * @brief   This sample code shows how to use STM32N6xx RTC HAL API to write/read
...
static void MX_RTC_Init(void)
{
  ...
  */
  ...
  privilegeState.rtcPrivilegeFeatures = RTC_PRIVILEGE_FEATURE_INIT|RTC_PRIVILEGE_FEATURE_TS;
...
static void MX_TAMP_RTC_Init(void)
{
  ...
  */
  ...
  sAllTamper.TampInput[RTC_ATAMP_1].Output = RTC_ATAMP_3;
