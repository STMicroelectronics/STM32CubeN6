...
/* SAI1 */
  ...
  */
    ...
    PeriphClkInitStruct.ICSelection[RCC_IC7].ClockDivider = 12;
    ...
    */
    ...
    __HAL_LINKDMA(hsai, hdmatx, handle_GPDMA1_Channel1);
...
/* SAI2 */
  ...
  */
    ...
    PeriphClkInitStruct.Sai2ClockSelection = RCC_SAI2CLKSOURCE_IC7;
    PeriphClkInitStruct.ICSelection[RCC_IC7].ClockSelection = RCC_ICCLKSOURCE_PLL4;
    PeriphClkInitStruct.ICSelection[RCC_IC7].ClockDivider = 12;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) != HAL_OK)
    {
...
/* SAI2 */
    ...
    PE11     ------> SAI2_SD_B
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_13|GPIO_PIN_12|GPIO_PIN_11);
