...
/**
  * @brief This function handles Serial Audio Interface 2 block B interrupt.
  */
void SAI2_B_IRQHandler(void)
{
  /* USER CODE BEGIN SAI2_B_IRQn 0 */

  /* USER CODE END SAI2_B_IRQn 0 */
  HAL_SAI_IRQHandler(&hsai_BlockB2);
  /* USER CODE BEGIN SAI2_B_IRQn 1 */

  /* USER CODE END SAI2_B_IRQn 1 */
}
