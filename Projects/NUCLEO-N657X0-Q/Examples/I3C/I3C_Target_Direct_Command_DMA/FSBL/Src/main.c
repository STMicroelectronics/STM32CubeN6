...
/**
  ******************************************************************************
  * @file    I3C/I3C_Target_Direct_Command_DMA/FSBL/Src/main.c
  * @author  MCD Application Team
  * @brief   This sample code shows how to use STM32N6xx I3C HAL API as Target
...
I3C_XferTypeDef aContextBuffers[1] __NON_CACHEABLE;
...
static void MX_I3C1_Init(void)
{
  ...
  hi3c1.Init.TgtBusCharacteristic.BusAvailableDuration = 0xc6;
