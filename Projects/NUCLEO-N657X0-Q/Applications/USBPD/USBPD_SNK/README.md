...
This application is a USBPD type C Consumer using Azure RTOS. USBPD Consumer: This application initialize the type C port 1 in Sink mode with only one PDO at 5V.
